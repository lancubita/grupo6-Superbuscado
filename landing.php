  ...
  <section class="bg-logos-sup d-flex align-items-center">
    <div class="container">
      <div class="row">
        ...
        <div class="col-2">
          <img class="logo-sp" src="assets/img/logo_walmart.png" alt="">
        </div>

        <div class="col-2">
          <img class="logo-sp" src="assets/img/logo_dia.png" alt="">
        </div>

        <div class="col-2">
          <img class="logo-sp" src="assets/img/logo_disco.png" alt="">
        </div>

        <div class="col-2">
          <img class="logo-sp" src="assets/img/logo_jumbo.png" alt="">
        </div>

        <div class="col-2">
          <img class="logo-sp" src="assets/img/logo_coto.png" alt="">
        </div>

        <div class="col-2">
          <img class="logo-sp" src="assets/img/logo_carrefour.png" alt="">
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-6 display-device">
          <img class="img-device mt-5" src="assets/img/devices.png" alt="">
        </div>
