              ...
              <form class="" action="register.php" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-12 d-flex justify-content-center">
                    <input class="input-login" type="text" name="name" value="<?php $_POST['name'] ?? '' ?>" placeholder="Nombre">
                  ...
                  <div class="col-12 d-flex justify-content-center">
                    <input class="input-login" type="text" name="lastname" value="<?php $_POST['lastname'] ?? '' ?>" placeholder="Apellido">
                  </div>
                  <div class="alert alert-danger">
                    <?=$errors['lastname'] ?? '' ?>
                  </div>
